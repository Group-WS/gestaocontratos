...
app.use(rotasDaObra);
/* O aditivo e a apresentacao moram em `documentosDaObra.js`, e nao numa rota
   por assunto como os outros: os dois sao DOCUMENTO de obra e gravam com a
   versao conferida pelo banco (supabase/salvar-aditivo-apresentacao.sql),
   que e' a mesma protecao da obra. Duas pessoas no mesmo aditivo deixaram de
   gravar uma por cima da outra por causa dele. */
